...
def test_regression():
    ...
    model = ExplicitFactorizationModel(
        loss='regression', n_iter=10, batch_size=1024, learning_rate=1e-3, l2=1e-5, use_cuda=CUDA)
    model.fit(train)
...
def test_poisson():
    ...
    model = ExplicitFactorizationModel(
        loss='poisson', n_iter=10, batch_size=1024, learning_rate=1e-3, l2=1e-6, use_cuda=CUDA)
    model.fit(train)
...
def test_logistic():
    ...
    model = ExplicitFactorizationModel(
        loss='logistic', n_iter=10, batch_size=1024, learning_rate=1e-3, l2=1e-6, use_cuda=CUDA)
    model.fit(train)
...
def test_check_input():
    ...
    model = ExplicitFactorizationModel(
        loss='regression', n_iter=1, batch_size=1024, learning_rate=1e-3, l2=1e-6, use_cuda=CUDA)
    model.fit(train)
