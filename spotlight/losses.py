...
def pointwise_loss(positive_predictions, negative_predictions, sample_weights=None):
    """
...
def bpr_loss(positive_predictions, negative_predictions, sample_weights=None):
    """
...
def hinge_loss(positive_predictions, negative_predictions, sample_weights=None):
    """
...
def adaptive_hinge_loss(positive_predictions, negative_predictions, sample_weights=None):
    """
    ...
    return hinge_loss(positive_predictions, highest_negative_predictions.squeeze(), sample_weights=sample_weights)


def regression_loss(observed_ratings, predicted_ratings, sample_weights=None):
    """
    Regression loss.
    Parameters
    ----------
...
def logistic_loss(observed_ratings, predicted_ratings, sample_weights=None):
    ...
    if sample_weights is not None:
        loss = F.binary_cross_entropy_with_logits(predicted_ratings, observed_ratings, size_average=False)
        return _weighted_loss(loss, sample_weights)
