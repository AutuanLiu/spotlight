...
html_context = {
    'css_files': ['_static/css/spotlight_theme.css'],
}
...
latex_documents = [
    (master_doc, 'spotlight.tex', u'Spotlight Documentation', u'Maciej Kula', 'manual'),
]
...
man_pages = [(master_doc, 'spotlight', u'Spotlight Documentation', [author], 1)]
...
texinfo_documents = [
    (master_doc, 'Spotlight', u'Spotlight Documentation', author, 'Spotlight', 'One line description of project.',
     'Miscellaneous'),
]
